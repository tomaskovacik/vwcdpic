...
;;
;; Monsoon bi-directional stateful protocol information was provided by
;; Andy Wilson. Thanks!
;;
;; $Log: vwcdpic-dump.asm,v $
;; Revision 1.1  2003/04/04 07:52:52  edwards
;; Initial import
;;
;; Revision 1.7.2.2  2002/12/01 08:45:42  edwards
;; Formatting changes for MPLAB IDE 6.
;;
;; Revision 1.7.2.1  2002/12/01 08:06:52  edwards
