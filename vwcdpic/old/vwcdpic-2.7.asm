...
Start:
	...
	IFDEF ARCHOS_SUPPORT		
	IFNDEF __16F627
		;; weak pullups are enabled for all pins by default at power on reset.

		;; Turn off the weak pull-up resistor for the Archos Serial TX
		;; pin. We need to use this pin as an open-drain output.
 		bcf		WPU, SerialTX9600
	ENDIF
	ENDIF
...
Do_UP:
		btfsc	progflags, playing ; skip this if we're not in play mode
